...
public class Test20 {
	...
	public static void main(String[] args) throws ParseException{
		...
		SimpleDateFormat f3 = new SimpleDateFormat("yy년 MM월 dd일 E요일 hh시 mm분 ss초");
		SimpleDateFormat f4 = new SimpleDateFormat("EEE, MMM d ,yy",new Locale("en"));
		SimpleDateFormat f5 = new SimpleDateFormat("yyy.MMMM.dd hh:mm aaa ", new Locale("en"));
		...
		SimpleDateFormat f6 = new SimpleDateFormat("yyy-MM-dd");
