...
public class HRSTest349 {
	  ...
	  //not  visible
		  ...
		  Manager m = (Manager) e;//down casting System.out.println("Manager 객체"); 
		  System.out.println(m.num_team); }
	  else if (e instanceof Consultant) { System.out.println("Consultant 객체"); }
	  else { System.out.println("Employee 객체"); } }
